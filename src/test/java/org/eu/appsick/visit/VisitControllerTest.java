...
class VisitControllerTest {
    ...
    void getDoctorVisits() {
        ...
        for (int i=0; i<10; i++){
            visitList.add(new Visit(new Long(2), null, doctor, null, null, false, null, null, Visit.VisitStatus.PENDING));
        }
    ...
    void getPatientVisits() {
        ...
        List<Visit> visitList = new ArrayList<>();
        for (int i=0; i<10; i++){
            visitList.add(new Visit(new Long(2), patient, null, null, null, false, null, null, Visit.VisitStatus.PENDING));
        }
    ...
    void getClinicVisits() {
        ...
        List<Visit> visitList = new ArrayList<>();
        for (int i=0; i<10; i++){
            visitList.add(new Visit(new Long(2), null, null, clinic, null, false, null, null, Visit.VisitStatus.PENDING));
        }
    ...
    void patchVisitReturnsHttpStatusOkWhenVisitExists() {
        Visit oldVisit = new Visit(new Long(2), null, null, null, null,
                false, null, null, Visit.VisitStatus.PENDING);
        Visit newVisit = new Visit(new Long(2), null, null, null, null,
