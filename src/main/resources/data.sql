...
INSERT INTO public.users (birth_date, email, first_name, last_name, password, sex, telephone_number, role) VALUES ('1990-12-28', 'aaa@aaa', 'Dobrosława', 'Szczepańska', '$2a$12$SWYKTX/gVxtPh5Oad.60tel2D9kVLNWvfC6YjfO/EH3.E69Z0d9GW', 1, '53 552 79 13',0);
INSERT INTO public.patients (pesel, premium, user_id) VALUES ('90122829944', true, 1);

INSERT INTO public.users (birth_date, email, first_name, last_name, password, sex, telephone_number, role) VALUES ('1993-09-24', 'benedyktasawicka@dayrep.com', 'Benedykta', 'Sawicka', 'Chi2Hooh', 1, '72 451 36 19', 1);
...
INSERT INTO public.users (birth_date, email, first_name, last_name, password, sex, telephone_number, image, role) VALUES ('1997-06-24', 'fryderykakwiatkowska@teleworm.us', 'Fryderyka', 'Kwiatkowska', 'Chi2Hooh', 1, '72 451 36 19', 'https://www.getmaple.ca/site-content/uploads/2020/08/female_dr.jpg', 1);
INSERT INTO public.doctors (about, user_id) VALUES ('Młoda i przebojowa', 3);
INSERT INTO public.medical_specialities (doctor_doctor_id, medical_specialities) VALUES (2, 1);

INSERT INTO public.users (birth_date, email, first_name, last_name, password, sex, telephone_number, role) VALUES ('1984-12-24', 'romanwojciechowski@armyspy.com', 'Roman', 'Wojciechowski', 'eiKah1oophe', 0, '72 672 17 82',1);
INSERT INTO public.doctors (about, user_id) VALUES ('Utalentowany', 4);
INSERT INTO public.medical_specialities (doctor_doctor_id, medical_specialities) VALUES (3, 3);
